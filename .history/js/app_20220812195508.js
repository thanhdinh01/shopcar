...
searchWrap.addEventListener("click", function (e) {
  if (e.target.firstElementChild.matches(".fa-magnifying-glass")) {
    e.target.firstElementChild.classList.add("fa-square-xmark");
    searchActive.style.display = "flex";
  }
  if (e.target.firstElementChild.matches(".fa-square-xmark")) {
    e.target.firstElementChild.classList.remove("fa-square-xmark");
    searchActive.style.display = "none";
  }
  console.log(e.target.firstElementChild.matches(".fa-magnifying-glass"));
});
