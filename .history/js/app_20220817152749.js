...
function renderCars(car) {
  // carList.innerHTML = "";
  // const carItem = carList.querySelectorAll("car-item");
  // carList.removeChild(carItem);
  carList.innerHTML = "";
  // console.log(btnMenuCar);
  const template = `
  <li class="car-item">
