...
const searchShow = document.querySelector(".search-active.is-show");
const searchScrolled = document.querySelector(
  ".search-active.is-show.search-scrolled"
);
...
window.addEventListener("scroll", function (e) {
  ...
  if (scrollY >= headerHeight * 1.5) {
    if (headerNav) {
      ...
      searchActive.style.marginTop = `${headerNav.offsetHeight}px`;
      // if (searchShow) {
      //   searchActive.classList.add("search-scrolled");
      //   if (searchScrolled) {
      //     searchScrolled.style.top = `${headerNav.offsetHeight}px`;
      //     console.log(searchScrolled);
      //   }
      // }
    }
  } else {
    ...
    searchActive.style.marginTop = `0px`;

    // searchActive.classList.remove("search-scrolled");
    // searchScrolled.style.top = `unset`;
  }
});
...
searchToggle.addEventListener("click", function (e) {
  if (
    ...
    searchActive.classList.toggle("search-scrolled");
