...
const dropDowns = document.querySelectorAll(
  ".menu-mobile-list .drop-down--mobile"
);
const btnCloseMobile = document.body.querySelector(".btn-close");
const menuListMobile = document.querySelector(".menu-list--mobile");
const menuMobile = document.documentElement.querySelector(
  ".menu-toggle--mobile"
);

menuListMobile.addEventListener("click", function (e) {
...
window.addEventListener("click", function (e) {
  console.log(e.target);
  if (!menuMobile.contains(e.target) && !e.target.matches(btnCloseMobile)) {
    menuMobile.classList.remove("show");
  }
});
